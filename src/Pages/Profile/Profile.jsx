...
export default function Profile() {
  ...
  useEffect(() => {
    if (controlMenulist.length > 0) {
      controlMenulist[0].style.color = "var(--color-primary)";
      controlMenulist[0].style.background = "var(--color-primary-light)";
    }
  }, [controlMenulist.length]);
  const isActive = (idx) => {
            ...
            {dashboardData && category === "dashboard" ? (
              ...
              <div className={classes.orders}>
                ...
                <div className={classes.item_in_Order}>
                  <p>Item in orders ( {dashboardData.orders.length} )</p>
                              ...
                              <ul className={classes.productDetailsList}>
                                <li>
                                  <p className={classes.color}>
                                    <span
                                      style={{ background: i.color.hexCode }}
                                    ></span>
                                    {i.color.colorName}
                                  </p>
                                </li>
                          ...
                          <div className={classes.status}>
                            <ul className={classes.status_list}>
                              <li className={classes.status_item_badge}>
                                <p className={classes.status_title}>Status :</p>
                              ...
                              <li className={classes.status_item}>
                                <p className={classes.status_title}>Seller :</p>
                                <p className={classes.status_content}>
                                  {i.seller}
                                </p>
                              </li>
                    ...
                    <div className={classes.shippingInputs}>
                      ...
                      <fieldset>
                        <label htmlFor="zip-code">
                          <p className={classes.title_input}>Zip/Postal Code</p>
                          <input
                            type="text"
                            id="zip-code"
